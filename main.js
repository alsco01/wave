...
class Circle {
    ...
    draw() {
        ctx.beginPath();
        ctx.strokeStyle = "rgba(85,63,227,0.25)";
		ctx.fillStyle = "rgba(85,63,227,0.25)";
        ...
        for (var i = 0; i < can.width - settings["grid size"]; i += settings["grid size"]) {
            for (var j = 0; j < can.height - settings["grid size"]; j += settings["grid size"]) {
                ...
                if (p1 != undefined && p2 != undefined) {
                    ctx.beginPath();
                    ctx.strokeStyle = "rgba(130,155,204,0.73)";
				    ctx.fillStyle = "rgba(130,155,204,0.73)";
