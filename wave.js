...
window.onresize = function (event) {
  ...
  TweenMax.set('.water-filler-back', { top: `-${waveHeight + 3}px` });
};
...
function loaderAnimation() {
  ...
  TweenMax.set('.water-filler-back', { top: `-${waveHeight + 3.5}px` });
  ...
  function endInitialAnimation() {
    TweenMax.to('.initialAnimation', .1, { autoAlpha: 0, onComplete: function () {
